...
- CI enforces independent coverage floors: at least 90% branch coverage for the pure routing core,
  plus at least 80% line and 70% branch coverage for the production Telecom-service boundary.
