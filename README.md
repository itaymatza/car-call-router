...
[**Download current APK**](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.6-debug/car-call-router-0.3.0-beta.6-debug.apk) · [All versions and release notes](https://github.com/itaymatza/car-call-router/releases)
...
The routing proof of concept has been confirmed by the project owner on the intended Samsung + Android Auto + native BMW Bluetooth setup: an active cellular call moved to the selected native hands-free endpoint, including its microphone, while Android Auto remained active. That confirms the core approach, not production reliability. Version `0.3.0-beta.6` adds generation-bound callback correlation and richer privacy-safe diagnostics while retaining the hardened routing behavior and Car Call Router product identity; see the [production-readiness gates](docs/PRODUCTION-READINESS.md).
...
| --- | --- | --- |
| `0.3.0-beta.6` | Android 14+ debug beta | [APK](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.6-debug/car-call-router-0.3.0-beta.6-debug.apk) · [SHA-256](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.6-debug/car-call-router-0.3.0-beta.6-debug.apk.sha256) · [Verification report](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.6-debug/apk-verification.txt) |
...
1. Download [**car-call-router-0.3.0-beta.6-debug.apk**](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.6-debug/car-call-router-0.3.0-beta.6-debug.apk).
