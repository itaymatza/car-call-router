...
[**Download current APK**](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.8-debug/car-call-router-0.3.0-beta.8-debug.apk) · [All versions and release notes](https://github.com/itaymatza/car-call-router/releases)
...
The routing proof of concept has been confirmed by the project owner on the intended Samsung + Android Auto + native BMW Bluetooth setup: an active cellular call moved to the selected native hands-free endpoint, including its microphone, while Android Auto remained active. That confirms the core approach, not production reliability. Version `0.3.0-beta.8` adds safe automatic recovery for Samsung's already-active Telecom binding while limiting HFP work to verified Android Auto projection; see the [production-readiness gates](docs/PRODUCTION-READINESS.md).
...
| --- | --- | --- |
| `0.3.0-beta.8` | Android 14+ debug beta | [APK](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.8-debug/car-call-router-0.3.0-beta.8-debug.apk) · [SHA-256](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.8-debug/car-call-router-0.3.0-beta.8-debug.apk.sha256) · [Verification report](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.8-debug/apk-verification.txt) |
...
1. Download [**car-call-router-0.3.0-beta.8-debug.apk**](https://github.com/itaymatza/car-call-router/releases/download/v0.3.0-beta.8-debug/car-call-router-0.3.0-beta.8-debug.apk).
