...
class HfpMonitor(c:Context,private val changed:()->Unit):AutoCloseable{
 ...
 companion object{
  var isKnown=true;var devices=setOf<String>();var audioDevices=setOf<String>()
  val instances=mutableListOf<HfpMonitor>()
  fun emit(value:Set<String>,known:Boolean=true){devices=value;isKnown=known;instances.toList().forEach{it.changed()}}
 }
}
